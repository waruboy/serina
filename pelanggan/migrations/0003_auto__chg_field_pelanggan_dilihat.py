...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pelanggan.dilihat'
        db.alter_column(u'pelanggan_pelanggan', 'dilihat', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Pelanggan.dilihat'
        db.alter_column(u'pelanggan_pelanggan', 'dilihat', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 15, 0, 0)))
