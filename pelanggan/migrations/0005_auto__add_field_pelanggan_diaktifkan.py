...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pelanggan.diaktifkan'
        db.add_column(u'pelanggan_pelanggan', 'diaktifkan',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pelanggan.diaktifkan'
        db.delete_column(u'pelanggan_pelanggan', 'diaktifkan')
