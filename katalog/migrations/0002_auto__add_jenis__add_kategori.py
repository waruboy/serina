...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Jenis'
        db.create_table(u'katalog_jenis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nama', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('merek', self.gf('django.db.models.fields.CharField')(max_length=63, blank=True)),
            ('kategori', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['katalog.Kategori'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=63)),
        ...
        db.send_create_signal(u'katalog', ['Jenis'])

        # Adding model 'Kategori'
        db.create_table(u'katalog_kategori', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nama', self.gf('django.db.models.fields.CharField')(max_length=63)),
        ...
        db.send_create_signal(u'katalog', ['Kategori'])


    def backwards(self, orm):
        # Deleting model 'Jenis'
        db.delete_table(u'katalog_jenis')

        # Deleting model 'Kategori'
        db.delete_table(u'katalog_kategori')
