...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Jenis.dilihat'
        db.alter_column(u'katalog_jenis', 'dilihat', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Kategori.dilihat'
        db.alter_column(u'katalog_kategori', 'dilihat', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Jenis.dilihat'
        db.alter_column(u'katalog_jenis', 'dilihat', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 13, 0, 0)))

        # Changing field 'Kategori.dilihat'
        db.alter_column(u'katalog_kategori', 'dilihat', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 13, 0, 0)))
