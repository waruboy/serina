...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Peminjaman.diubah'
        db.add_column(u'peminjaman_peminjaman', 'diubah',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 5, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Peminjaman.diubah'
        db.delete_column(u'peminjaman_peminjaman', 'diubah')
