...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemKeranjang.diskon'
        db.add_column(u'keranjang_itemkeranjang', 'diskon',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemKeranjang.diskon'
        db.delete_column(u'keranjang_itemkeranjang', 'diskon')
