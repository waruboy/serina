...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemKeranjang.keterangan'
        db.add_column(u'keranjang_itemkeranjang', 'keterangan',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemKeranjang.keterangan'
        db.delete_column(u'keranjang_itemkeranjang', 'keterangan')
